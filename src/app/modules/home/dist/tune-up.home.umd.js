(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/router'), require('@angular/common/http'), require('@tune-up/core'), require('@angular/platform-browser')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/router', '@angular/common/http', '@tune-up/core', '@angular/platform-browser'], factory) :
	(factory((global.tuneUp = global.tuneUp || {}, global.tuneUp.home = {}),global.tuneUp.vendor.ngCore,global.tuneUp.vendor.ngRouter,global.tuneUp.vendor.ngCommonHttp,global.tuneUp.app,global.tuneUp.vendor.ngPlatformBrowser));
}(this, (function (exports,core,router,http,core$1,platformBrowser) { 'use strict';
    ...
    this.filterUts = function (idActivity, status) {
      _this.utsToShow = _this.allUts.filter(function (ut) {
        return (
          ...
          status === 'ALL' || ut.Estado === status || ut.Estado === 'ACTIVE' && status === 'DOING'
        );
      });
    };
...
var SafeHtml = (_dec$8 = core.Pipe({ name: 'safeHtml' }), _dec$8(_class$8 = function () {
