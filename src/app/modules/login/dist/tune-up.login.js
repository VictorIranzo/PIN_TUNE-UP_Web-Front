...
import { NotificationsService, TuneUpCoreModule, configService } from '@tune-up/core';
import { Component, EventEmitter, Injectable, Input, NgModule, Output, ViewChild } from '@angular/core';
import { ActivatedRoute, Router, RouterModule } from '@angular/router';
import { AboutService, AgentService, AuthService } from '@tune-up/app';
...
}), _dec2 = ViewChild('emailCtrl'), _dec$2(_class$2 = (_class2 = function () {
...
Reflect.defineMetadata('design:paramtypes', [ActivatedRoute, Router, LoginService, SitesService, AuthService, AgentService, AboutService, NotificationsService], LoginComponent);
...
var SiteSelectorComponent = (_dec$5 = Component({
  ...
  template: html$1
}), _dec2$1 = Input(), _dec3 = Output(), _dec$5(_class$5 = (_class2$1 = function SiteSelectorComponent() {
  var _this = this;
