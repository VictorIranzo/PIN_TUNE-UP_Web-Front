...
var DetailsComponent = (_dec$3 = core.Component({
  ...
  function DetailsComponent(route, router$$1, detailsService, notificationsService, breadcrumbService) {
    var _this = this;
...
Reflect.defineMetadata('design:paramtypes', [router.ActivatedRoute, router.Router, DetailsService, core$1.NotificationsService, app.BreadcrumbService], DetailsComponent);
...
var FollowupsComponent = (_dec$12 = core.Component({
  ...
  function FollowupsComponent(followupsService, agentService) {
    var _this = this;
...
Reflect.defineMetadata('design:paramtypes', [FollowupsService, app.AgentService], FollowupsComponent);
